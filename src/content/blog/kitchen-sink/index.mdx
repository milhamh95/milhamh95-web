...
import ApiFlowAnimation from "../../../components/ApiFlowAnimation.astro";
import KafkaPartitionKey from "../../../components/KafkaPartitionKey.astro";
import KafkaPartitionKeyMotion from "../../../components/KafkaPartitionKeyMotion.tsx";
...
## Kafka partition key animation (vanilla JS)

<KafkaPartitionKey />

## Kafka partition key animation (framer motion)

<KafkaPartitionKeyMotion client:load />
