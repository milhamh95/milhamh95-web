...
This post exists only to have enough headings and text to scroll through, so the
"On this page" sidebar has something real to jump between. Only `##` headings show up
in the sidebar; `###` still work as regular subheadings in the post itself.

## Introduction

Nothing special here, just enough words to push the page down. Lorem ipsum dolor sit
...
lacus eget erat. Cras mollis scelerisque nunc. Nullam arcu. Aliquam consequat.

## Setting the scene

More filler text to add height. Sed ut perspiciatis unde omnis iste natus error sit
...
pharetra auctor, sem massa mattis sem, at interdum magna augue eget diam. Vestibulum
...
Sed quia non numquam eiusmod tempora incidunt ut labore et dolore magnam aliquam
...
That's the whole post. Scroll back up and click around in the sidebar — each link
should jump straight to its section and light up purple as you pass it.
...
asperiores repellat, so this really is the bottom of the page now.
